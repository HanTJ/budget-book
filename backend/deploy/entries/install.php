...
/**
 * 닷홈 배포용 1회성 설치 스크립트.
 * 반드시 precheck.php 가 통과한 상태여야 안전하게 실행 가능.
 * 설치 완료 후 이 파일과 precheck.php 를 FTP 에서 삭제.
 */
...
if (!is_file($autoload)) {
    ...
    echo '<!doctype html><meta charset="utf-8"><h1>설치 불가</h1><p>app/vendor/ 가 업로드되지 않았습니다.</p>';
    exit;
}
require $autoload;
...
$buildInstaller = static function () use ($sentinelPath): Installer {
    ...
    return new Installer(
        ...
        migrator: new PhinxMigrator(
            configPath: __DIR__ . '/../app/config/phinx.php',
